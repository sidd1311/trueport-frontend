    ...
    <div className="card hover:shadow-md transition-shadow">
      <div className="flex justify-between items-start mb-4">
        <div className="flex-1">
          <h3 className="text-lg font-semibold text-gray-900 mb-1">{courseName}</h3>
          <p className="text-sm text-primary-600 mb-1">{getCourseTypeLabel(courseType)}</p>
          <p className="text-sm text-gray-600 mb-1">{schoolOrCollege}</p>
